...
public class UserDAO extends ConnectionDatabase {
    private final String CHECK_LOGIN = "SELECT * FROM music_md3.user where user_name = ? and password = ?;";
    ...
    private final String CHECK_EXIST_USERNAME ="SELECT * FROM music_md3.user where user_name = ?";
