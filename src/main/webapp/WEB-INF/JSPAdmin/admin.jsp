...
<div class="sidebar">
  ...
  <div class="side-content">
    <div class="profile">
      <div class="profile-img bg-img" style="background-image: url(1.jpg)"></div>
      <h4>Admin</h4>
  ...
  <header>
    <div class="header-content">
      ...
      <div class="header-menu">
        ...
        <div class="user">
          <div class="bg-img" style="background-image: url(1.jpg)"></div>
        ...
        <div>
          <table width="100%">
            ...
            <tr>
              ...
              <td>
                <div class="client">
                  <div class="client-img bg-img" style="background-image: url(/1.jpg)"></div>
                  <div class="client-info">
                    <h4>Bông Hoa Đẹp Nhất</h4>
                    <small>Quân AP</small>
                  </div>
                </div>
              </td>
              ...
              <td>
                <audio style="height: 30px" controls class="song-play">
                  <source src="/Charlie Puth - Attention.mp3" type="audio/mp3">
                </audio>
              </td>
              <td>
                <div class="actions">
                  <span class="las la-pen-square" style="margin-left: 23px;"></span>
