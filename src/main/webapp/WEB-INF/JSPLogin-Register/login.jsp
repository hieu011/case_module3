...
<div class="wrapper">
    <nav class="nav">
        <div class="nav-button">
            <A href="/login"><button class="btn white-btn" id="loginBtn" onclick="login()">Đăng Nhập</button></A>
            <a href="/register"><button class="btn" id="registerBtn" onclick="register()">Đăng Ký</button></a>
        </div>
    ...
    <div class="form-box">
        ...
        <div class="login-container" id="login">
            <div class="top">
                <span>Chưa có tài khoản? <a href="/register" onclick="register()" id="register-text">Đăng ký ngay!</a></span>
            ...
            <div class="two-col">
                ...
                <div class="two">
                    <label><a href="#" onclick="alert('Tính năng này chưa được phát triển :< ')">Quên mật khẩu?</a></label>
                </div>
            </div>
        </div>
    </div>
