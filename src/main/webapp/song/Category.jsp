                        ...
                        <table width="100%">
                            ...
                            <c:forEach items="${categories}" var="category">
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a href="/authors?action=edit&id=${category.getId()}"><span class="las la-pen-square" style="margin-left: 23px;"></span></a>
                                            <a href="javascript:void(0)" onclick="handleDeleteClick(${category.getId()},'${category.getName()}')" style="margin-left: 40px"><span class="las la-trash-alt" ></span></a>
                                        </div>
                                    </td>
                                </tr>
                            </c:forEach>
