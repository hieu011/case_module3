...
<div class="main-content">
  ...
  <main>
    ...
    <div class="page-header">
      <h1>Trang Chủ</h1>
      <small>Trang Chủ / Quản Lý User</small>
    </div>
      ...
      <div class="records table-responsive">
        <div>
          ...
          <table width="100%">
            ...
            <tr>
              <th>ID</th>
              <th><span class="las la-sort"></span> TÊN USER</th>
            ...
            <tr>
              ...
              <td>
                <div class="client">
                  <div><span class="las la-user-alt"></span></div>
              ...
              <td>
                <div class="actions">
<%--                  <a href="/users?action=edit&id=${user.getId()}"><span class="las la-pen-square" style="margin-left: 23px;"></span></a>--%>
                  <a href="javascript:void(0)" onclick="handleDeleteClick(${user.getId()},'${user.getUsername()}')" style="margin-left: 40px"><span class="las la-trash-alt" ></span></a>
                </div>
              </td>
            </tr>
              </c:forEach>
...
<script>
  function handleDeleteClick(id, username){
    Swal.fire({
      title: 'Are you sure?',
      text: "Bạn có muốn xóa người dùng " + username + " hay không?",
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        location.assign("/users?action=delete&id=" + id);
      }
    })
  }
</script>

<c:if test="${sessionScope.messageDeleteUser !=null}">
  <script>
    window.onload = ()=>{
      Swal.fire({
        position: 'top-end',
  ...
  <% session.setAttribute("messageDeleteUser", null);%>
</c:if>
